        ...
        <div class="col-sm-9" style="margin-left:10px"> 
            ...
            <form action="edit_user.php" name="form" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-7 ">
                    ...
                    <input class="input-lg" style="font-size:18px; width:330px" name="email" type="text"  id="email" value="<?php echo $user_name; ?>" autofocus><br><br>
                </div>
                <div class="col-sm-7 ">
                    <label style="font-size:18px;">Password</label><br>
                    <input class="input-lg" style="font-size:18px; width:330px" name="password" type="text"  id="password" value="<?php echo $user_password; ?>">
                        <br><br>
                </div>
                <div class="col-sm-7">
                    <a href="manage_users.php" class="btn btn-warning " style="font-size:18px">Kembali</a>
