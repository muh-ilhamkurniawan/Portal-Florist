        ...
        echo( mysqli_error($con));
            ...
            if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
            {
                if($picture_size<=50000000)
                    ...
                    move_uploaded_file($picture_tmp_name,"struk_images/".$pic_name);
                    
                    $sql = "INSERT INTO `orders_info` 
                    (`order_id`,`user_id`,`f_name`, `email`,`address`, 
                    `city`, `prod_count`,`total_amt`, `struk`, `noref`,`keterangan`) 
                    VALUES ($order_id, '$user_id','$f_name','$email', 
                    '$address', '$city','$total_count','$prod_total','$pic_name','$noref','$keterangan')";
